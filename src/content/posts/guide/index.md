...
- **Site Configuration**: Learn about global settings in `src/config/siteConfig.ts` and [`src/config/README.md`](https://github.com/xiaoxuanaichitao/Shirone/blob/main/src/config/README.md).
- **Design Tokens**: Explore tokens and color palettes in `DESIGN.md` and `docs/m3e-standard.md`.
- **Feedback & Community**: Share your ideas and questions on [GitHub Issues](https://github.com/xiaoxuanaichitao/Shirone/issues).
